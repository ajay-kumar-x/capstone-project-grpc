...
public final class ProfileServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.goconsult.grpc.user.User.Empty,
      com.goconsult.grpc.user.User.user> getViewProfileMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "viewProfile",
      requestType = com.goconsult.grpc.user.User.Empty.class,
      responseType = com.goconsult.grpc.user.User.user.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.goconsult.grpc.user.User.Empty,
      com.goconsult.grpc.user.User.user> getViewProfileMethod() {
    io.grpc.MethodDescriptor<com.goconsult.grpc.user.User.Empty, com.goconsult.grpc.user.User.user> getViewProfileMethod;
      ...
      synchronized (ProfileServiceGrpc.class) {
        if ((getViewProfileMethod = ProfileServiceGrpc.getViewProfileMethod) == null) {
          ProfileServiceGrpc.getViewProfileMethod = getViewProfileMethod = 
              io.grpc.MethodDescriptor.<com.goconsult.grpc.user.User.Empty, com.goconsult.grpc.user.User.user>newBuilder()
              ...
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.goconsult.grpc.user.User.user.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.goconsult.grpc.user.User.user,
      com.goconsult.grpc.user.User.responseMessage> getUpdateProfileMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "updateProfile",
      requestType = com.goconsult.grpc.user.User.user.class,
      responseType = com.goconsult.grpc.user.User.responseMessage.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.goconsult.grpc.user.User.user,
      com.goconsult.grpc.user.User.responseMessage> getUpdateProfileMethod() {
    io.grpc.MethodDescriptor<com.goconsult.grpc.user.User.user, com.goconsult.grpc.user.User.responseMessage> getUpdateProfileMethod;
      ...
      synchronized (ProfileServiceGrpc.class) {
        if ((getUpdateProfileMethod = ProfileServiceGrpc.getUpdateProfileMethod) == null) {
          ProfileServiceGrpc.getUpdateProfileMethod = getUpdateProfileMethod = 
              io.grpc.MethodDescriptor.<com.goconsult.grpc.user.User.user, com.goconsult.grpc.user.User.responseMessage>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
  ...
  private static volatile io.grpc.MethodDescriptor<com.goconsult.grpc.user.User.updatePasswordDetail,
      com.goconsult.grpc.user.User.responseMessage> getUpdatePasswordMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "updatePassword",
      requestType = com.goconsult.grpc.user.User.updatePasswordDetail.class,
      responseType = com.goconsult.grpc.user.User.responseMessage.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.goconsult.grpc.user.User.updatePasswordDetail,
      com.goconsult.grpc.user.User.responseMessage> getUpdatePasswordMethod() {
    io.grpc.MethodDescriptor<com.goconsult.grpc.user.User.updatePasswordDetail, com.goconsult.grpc.user.User.responseMessage> getUpdatePasswordMethod;
      ...
      synchronized (ProfileServiceGrpc.class) {
        if ((getUpdatePasswordMethod = ProfileServiceGrpc.getUpdatePasswordMethod) == null) {
          ProfileServiceGrpc.getUpdatePasswordMethod = getUpdatePasswordMethod = 
              io.grpc.MethodDescriptor.<com.goconsult.grpc.user.User.updatePasswordDetail, com.goconsult.grpc.user.User.responseMessage>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "ProfileService", "updatePassword"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.goconsult.grpc.user.User.updatePasswordDetail.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.goconsult.grpc.user.User.responseMessage.getDefaultInstance()))
  ...
  public static abstract class ProfileServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void viewProfile(com.goconsult.grpc.user.User.Empty request,
        io.grpc.stub.StreamObserver<com.goconsult.grpc.user.User.user> responseObserver) {
      asyncUnimplementedUnaryCall(getViewProfileMethod(), responseObserver);
    }

    /**
     */
    public void updateProfile(com.goconsult.grpc.user.User.user request,
    ...
    /**
     */
    public void updatePassword(com.goconsult.grpc.user.User.updatePasswordDetail request,
        io.grpc.stub.StreamObserver<com.goconsult.grpc.user.User.responseMessage> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                ...
                com.goconsult.grpc.user.User.user>(
          ...
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.goconsult.grpc.user.User.updatePasswordDetail,
                com.goconsult.grpc.user.User.responseMessage>(
  ...
  public static final class ProfileServiceBlockingStub extends io.grpc.stub.AbstractStub<ProfileServiceBlockingStub> {
    ...
    /**
     */
    public com.goconsult.grpc.user.User.user viewProfile(com.goconsult.grpc.user.User.Empty request) {
    ...
    /**
     */
    public com.goconsult.grpc.user.User.responseMessage updateProfile(com.goconsult.grpc.user.User.user request) {
      return blockingUnaryCall(
    ...
    /**
     */
    public com.goconsult.grpc.user.User.responseMessage updatePassword(com.goconsult.grpc.user.User.updatePasswordDetail request) {
      return blockingUnaryCall(
  ...
  public static final class ProfileServiceFutureStub extends io.grpc.stub.AbstractStub<ProfileServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.goconsult.grpc.user.User.user> viewProfile(
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.goconsult.grpc.user.User.responseMessage> updateProfile(
        com.goconsult.grpc.user.User.user request) {
      return futureUnaryCall(
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.goconsult.grpc.user.User.responseMessage> updatePassword(
        com.goconsult.grpc.user.User.updatePasswordDetail request) {
      return futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_VIEW_PROFILE:
          serviceImpl.viewProfile((com.goconsult.grpc.user.User.Empty) request,
              (io.grpc.stub.StreamObserver<com.goconsult.grpc.user.User.user>) responseObserver);
          break;
        case METHODID_UPDATE_PROFILE:
          serviceImpl.updateProfile((com.goconsult.grpc.user.User.user) request,
              (io.grpc.stub.StreamObserver<com.goconsult.grpc.user.User.responseMessage>) responseObserver);
          break;
        case METHODID_UPDATE_PASSWORD:
          serviceImpl.updatePassword((com.goconsult.grpc.user.User.updatePasswordDetail) request,
              (io.grpc.stub.StreamObserver<com.goconsult.grpc.user.User.responseMessage>) responseObserver);
          break;
        default:
