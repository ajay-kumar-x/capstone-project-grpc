...
public final class BookingServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.goconsult.grpc.counselor.Counselor.Empty,
      com.goconsult.grpc.counselor.Counselor.userSlotArr> getViewBookedSlotsMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "viewBookedSlots",
      requestType = com.goconsult.grpc.counselor.Counselor.Empty.class,
      responseType = com.goconsult.grpc.counselor.Counselor.userSlotArr.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.goconsult.grpc.counselor.Counselor.Empty,
      com.goconsult.grpc.counselor.Counselor.userSlotArr> getViewBookedSlotsMethod() {
    io.grpc.MethodDescriptor<com.goconsult.grpc.counselor.Counselor.Empty, com.goconsult.grpc.counselor.Counselor.userSlotArr> getViewBookedSlotsMethod;
      ...
      synchronized (BookingServiceGrpc.class) {
        if ((getViewBookedSlotsMethod = BookingServiceGrpc.getViewBookedSlotsMethod) == null) {
          BookingServiceGrpc.getViewBookedSlotsMethod = getViewBookedSlotsMethod = 
              io.grpc.MethodDescriptor.<com.goconsult.grpc.counselor.Counselor.Empty, com.goconsult.grpc.counselor.Counselor.userSlotArr>newBuilder()
              ...
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.goconsult.grpc.counselor.Counselor.userSlotArr.getDefaultInstance()))
  ...
  public static abstract class BookingServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void viewBookedSlots(com.goconsult.grpc.counselor.Counselor.Empty request,
        io.grpc.stub.StreamObserver<com.goconsult.grpc.counselor.Counselor.userSlotArr> responseObserver) {
          ...
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                ...
                com.goconsult.grpc.counselor.Counselor.userSlotArr>(
  ...
  public static final class BookingServiceBlockingStub extends io.grpc.stub.AbstractStub<BookingServiceBlockingStub> {
    ...
    /**
     */
    public com.goconsult.grpc.counselor.Counselor.userSlotArr viewBookedSlots(com.goconsult.grpc.counselor.Counselor.Empty request) {
  ...
  public static final class BookingServiceFutureStub extends io.grpc.stub.AbstractStub<BookingServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.goconsult.grpc.counselor.Counselor.userSlotArr> viewBookedSlots(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_VIEW_BOOKED_SLOTS:
          serviceImpl.viewBookedSlots((com.goconsult.grpc.counselor.Counselor.Empty) request,
              (io.grpc.stub.StreamObserver<com.goconsult.grpc.counselor.Counselor.userSlotArr>) responseObserver);
          break;
        default:
