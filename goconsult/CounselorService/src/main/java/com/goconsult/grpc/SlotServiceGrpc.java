...
public final class SlotServiceGrpc {
  ...
  public static io.grpc.MethodDescriptor<com.goconsult.grpc.Counselor.Empty,
    ...
    if ((getViewBookedSlotsMethod = SlotServiceGrpc.getViewBookedSlotsMethod) == null) {
      synchronized (SlotServiceGrpc.class) {
        if ((getViewBookedSlotsMethod = SlotServiceGrpc.getViewBookedSlotsMethod) == null) {
          SlotServiceGrpc.getViewBookedSlotsMethod = getViewBookedSlotsMethod = 
              io.grpc.MethodDescriptor.<com.goconsult.grpc.Counselor.Empty, com.goconsult.grpc.Counselor.userSlotArr>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "SlotService", "viewBookedSlots"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.goconsult.grpc.Counselor.Empty.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.goconsult.grpc.Counselor.userSlotArr.getDefaultInstance()))
                  .setSchemaDescriptor(new SlotServiceMethodDescriptorSupplier("viewBookedSlots"))
                  .build();
          }
        }
     }
  ...
  private static final int METHODID_VIEW_BOOKED_SLOTS = 4;
