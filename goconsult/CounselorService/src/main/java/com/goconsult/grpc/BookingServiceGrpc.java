...
public final class BookingServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.goconsult.grpc.Booking.rescheduleDetail,
      com.goconsult.grpc.Booking.bookingResponse> getRescheduleBookingMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "rescheduleBooking",
      requestType = com.goconsult.grpc.Booking.rescheduleDetail.class,
      responseType = com.goconsult.grpc.Booking.bookingResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.goconsult.grpc.Booking.rescheduleDetail,
      com.goconsult.grpc.Booking.bookingResponse> getRescheduleBookingMethod() {
    io.grpc.MethodDescriptor<com.goconsult.grpc.Booking.rescheduleDetail, com.goconsult.grpc.Booking.bookingResponse> getRescheduleBookingMethod;
      ...
      synchronized (BookingServiceGrpc.class) {
        if ((getRescheduleBookingMethod = BookingServiceGrpc.getRescheduleBookingMethod) == null) {
          BookingServiceGrpc.getRescheduleBookingMethod = getRescheduleBookingMethod = 
              io.grpc.MethodDescriptor.<com.goconsult.grpc.Booking.rescheduleDetail, com.goconsult.grpc.Booking.bookingResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "BookingService", "rescheduleBooking"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.goconsult.grpc.Booking.rescheduleDetail.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.goconsult.grpc.Booking.bookingResponse.getDefaultInstance()))
  ...
  public static abstract class BookingServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void rescheduleBooking(com.goconsult.grpc.Booking.rescheduleDetail request,
        io.grpc.stub.StreamObserver<com.goconsult.grpc.Booking.bookingResponse> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          ...
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.goconsult.grpc.Booking.rescheduleDetail,
                com.goconsult.grpc.Booking.bookingResponse>(
  ...
  public static final class BookingServiceBlockingStub extends io.grpc.stub.AbstractStub<BookingServiceBlockingStub> {
     ...
     * </pre>
     */
    public com.goconsult.grpc.Booking.bookingResponse rescheduleBooking(com.goconsult.grpc.Booking.rescheduleDetail request) {
      return blockingUnaryCall(
  ...
  public static final class BookingServiceFutureStub extends io.grpc.stub.AbstractStub<BookingServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.goconsult.grpc.Booking.bookingResponse> rescheduleBooking(
        com.goconsult.grpc.Booking.rescheduleDetail request) {
      return futureUnaryCall(
  ...
  private static final int METHODID_VIEW_BOOKED_SLOT_FOR_COUNSELOR = 3;
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        ...
        case METHODID_RESCHEDULE_BOOKING:
          serviceImpl.rescheduleBooking((com.goconsult.grpc.Booking.rescheduleDetail) request,
              (io.grpc.stub.StreamObserver<com.goconsult.grpc.Booking.bookingResponse>) responseObserver);
          break;
