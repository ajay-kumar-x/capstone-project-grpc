...
public class AuthService extends AuthServiceGrpc.AuthServiceImplBase {
    ...
    @Override
    public void register(Auth.user request, StreamObserver<Auth.registerMessage> responseObserver) {

        Auth.registerMessage.Builder response=Auth.registerMessage.newBuilder();

        String result="";
        if(!request.getUserType().equals("")|| !request.getEmail().equals("")|| !request.equals(""))
        {
